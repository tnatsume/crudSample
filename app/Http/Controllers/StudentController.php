...
class StudentController extends Controller
{
    public function getIndex(Request $req)
    {
        ...
        $students = $query->sortable()->paginate(10);
    ...
    public function new_finish(Request $req){
        ...
        $student->tel = $this->format_phone_number($req->tel);

        $student->save();
        return redirect()->to('student/list')->with('message','登録が完了しました。');
    }

    public function edit_index($id){
        $student = \App\Student::findOrFail($id);
        $student->tel = str_replace(array('-', 'ー', '−', '―', '‐'), '', $student->tel);
    ...
    public function edit_finish(Request $req, $id){
        ...
        $student->save();
        return redirect()->to('student/list')->with('message',$id.'の編集が完了しました');
    }
    ...
    public function delete($id){
        ...
        $student->delete();
        return redirect()->to('student/list')->with('message',$id.'の削除が完了しました。');
    }
